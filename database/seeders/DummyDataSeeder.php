    ...
    public function run(): void
    {
        ...
        $products = [
            [
                'category_id' => 1,
                'product_code' => 'PRD001',
                'product_name' => 'Cheeseburger Supreme',
            ...
            [
                'category_id' => 3,
                'product_code' => 'PRD003',
                'product_name' => 'Fresh Salmon Sushi Set',
                'description' => 'Fresh Atlantic salmon nigiri and avocado roll set served with ginger.',
                'cost_price' => 7.00,
                'selling_price' => 14.99,
                'stock_qty' => 30,
            ...
            [
                'category_id' => 3,
                'product_code' => 'PRD007',
                'product_name' => 'Tonkotsu Pork Ramen',
            ...
            [
                ...
                'description' => 'Prime ribeye steak grilled to perfection with herb butter and side veggies.',
                'cost_price' => 9.00,
                'selling_price' => 18.99,
                'stock_qty' => 25,
            ...
            [
                'category_id' => 5,
                'product_code' => 'PRD014',
                'product_name' => 'Berry Smoothie Bowl',
                'description' => 'Refreshing berry blend topped with fresh banana, chia seeds, and granola.',
                'cost_price' => 2.20,
                'selling_price' => 5.50,
                'stock_qty' => 50,
            ...
            [
                'category_id' => 5,
                'product_code' => 'PRD015',
                'product_name' => 'Assorted Glazed Donuts',
                'description' => 'Half-dozen freshly baked glazed and frosted sweet donuts.',
                'cost_price' => 2.50,
                'selling_price' => 6.50,
                'stock_qty' => 55,
            ...
            [
                'category_id' => 1,
                'product_code' => 'PRD016',
                'product_name' => 'Classic Club Sandwich',
                'description' => 'Triple-decker toasted sandwich with roasted chicken, bacon, lettuce, and tomato.',
                'cost_price' => 3.20,
                'selling_price' => 7.99,
                'stock_qty' => 60,
