...
<div class="product-detail-page">
    <div class="container">
        ...
        <!-- Back Button -->
        <a href="{{ route('products.index') }}" class="btn btn-outline-secondary btn-sm mb-4 rounded-pill px-3 py-2 fw-semibold">
            ...
            <div class="card-body p-4 p-md-5">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-md-7">
                        ...
                        <!-- Action Form -->
                        <form action="{{ route('cart.add', $product->id) }}" method="POST" class="add-to-cart-form d-flex align-items-center gap-3 flex-wrap">
                            @csrf
                            ...
                            <div class="input-group" style="width: 130px;">
                                ...
                                <input type="number" name="quantity" class="form-control text-center fw-bold" value="1" min="1" max="99">
                            ...
                            <a href="{{ route('products.index') }}" class="btn btn-light px-4 py-2.5 border rounded-pill fw-semibold text-secondary">
                                Continue Shopping
                            </a>
                        </form>
                    </div>
