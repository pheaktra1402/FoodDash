                        ...
                        <tbody>
                            @foreach ($products as $product)
                                <tr>
                                    <!-- Code -->
                                    <td>
                                        <span class="badge bg-secondary font-monospace">{{ $product->product_code ?? 'N/A' }}</span>
                                    </td>
                                    ...
                                    <td class="text-center" style="width: 80px;">
                                        @if($product->image)
                                            <!-- UPDATE THIS: -->
<img src="{{ asset('storage/' . $product->image) }}" class="img-thumbnail" style="width: 60px; height: 60px; object-fit: cover;">
                                        @else
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-2">
                                            <!-- Edit -->
                                            <a href="{{ route('admin.products.edit', $product->id) }}" class="btn btn-outline-primary btn-sm py-1 px-2">
                                                Edit
                                            </a>
