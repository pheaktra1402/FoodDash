        ...
        <div class="bg-white rounded-3xl shadow-xl overflow-hidden p-6 sm:p-8 lg:p-10 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div class="w-full max-w-md mx-auto">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-4">
                    ...
                    <div>
                        <input id="email" 
                            class="w-full rounded-full border border-slate-300 bg-white px-5 py-3 text-sm text-slate-800 placeholder-slate-400 focus:border-slate-900 focus:ring-slate-900 focus:outline-none" 
                            type="email" name="email" :value="old('email')" required autofocus placeholder="Username / Email" />
            ...
            <!-- RIGHT COLUMN: Image (អេក្រង់ធំទើបបង្ហាញ) -->
