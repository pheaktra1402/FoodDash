...
<style>
    ...
    /* Updated Icon Box to match Custom Pink Theme */
    .icon-box {
        width: 52px;
        height: 52px;
        border-radius: 12px;
...
<div class="bg-white">
    ...
    <div class="about-hero text-center text-white">
        ...
        <div class="container position-relative py-4">
            <h1 class="display-4 fw-bold" style="font-family: 'Plus Jakarta Sans', sans-serif;">About Us</h1>
    ...
    <div class="container py-5 my-4">
        <div class="text-center">
            <span class="text-uppercase fw-semibold small tracking-wide" style="color: #F43F5E;">Our Mission</span>
            <h2 class="display-5 fw-bold text-dark mt-2" style="font-family: 'Plus Jakarta Sans', sans-serif;">Quality food, fast delivery.</h2>
        ...
        <div class="row g-4 mt-5">
            <!-- Feature 1 -->
            <div class="col-md-4">
                <div class="d-flex align-items-start gap-3 p-4 rounded-4 border bg-light h-100 shadow-sm transition" style="border-color: #E2E8F0 !important;">
